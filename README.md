...
- **Real-time Live Progress Bar**: Indikator persentase, live counter jumlah akun Following & Followers yang sedang diambil, dan log status per halaman/batch via Server-Sent Events (SSE).
